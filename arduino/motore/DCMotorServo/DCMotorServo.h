...
class DCMotorServo {
public:
  DCMotorServo(uint8_t pin_dir_1 = 4,  uint8_t pin_pwm_output = 6, uint8_t pin_encode1 = 2, uint8_t pin_encode2 = 3);
...
private:
  ...
  double I,P,D,Integral,Last;
  
  uint8_t _pin_PWM_output, _pin_dir_1;
  double targetRPM, currentRPM;
  double _PID_input, _PID_output;
