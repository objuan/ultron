#ifndef _ROS_omni_shot_way_point_h
#define _ROS_omni_shot_way_point_h
...
namespace omni_shot
{
  ...
  class way_point : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "omni_shot/way_point"; };
    const char * getMD5(){ return "7a2108d72ba8b9d071bebbbcd7bc09af"; };
